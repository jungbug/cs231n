...
def affine_forward(x, w, b):
    ...
    Inputs:
    - x: A numpy array containing input data, of shape (N, d_1, ..., d_k) shape (2, 4, 5, 6)
    - w: A numpy array of weights, of shape (D, M) shape (120,3)
    - b: A numpy array of biases, of shape (M,) (3,)

    Returns a tuple of:
    - out: output, of shape (N, M)  2,3
    - cache: (x, w, b)
    """
    out = None
    ###########################################################################
...
def affine_backward(dout, cache):
    ...
    Inputs:
    - dout: Upstream derivative, of shape (N, M) 10,5
    - cache: Tuple of:
    ...
    - dw: Gradient with respect to w, of shape (D, M) 6,5
...
def softmax_loss(x, y):
    ...
    N = len(y)
    P = np.exp(x - x.max(axis = 1, keepdims = True)) #numerically stable exponent
